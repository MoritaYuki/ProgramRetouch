				...
				<div class="card grey lighten-5">
					<div class="card-content">
						<table class="bordered">
							...
							<tbody>
								<c:forEach var="bhl" items="${buyHistoryList}" >
									<tr>
										<td class="center"><a href="UserBuyHistoryDetail?id=${bhl.id}&buyDate=${bhl.getFormatDate()}&deliveryMethodName=${bhl.deliveryMethodName}&totalPrice=${bhl.totalPrice}&deliveryMethodPrice=${bhl.deliveryMethodPrice}" class="btn-floating btn waves-effect waves-light "> <i class="material-icons">details</i></a></td>
										<td class="center">${bhl.getFormatDate()}</td>
										<td class="center">${bhl.deliveryMethodName}</td>
										<td class="center">${bhl.totalPrice} 円</td>
									</tr>
								</c:forEach>
							</tbody>
						</table>
